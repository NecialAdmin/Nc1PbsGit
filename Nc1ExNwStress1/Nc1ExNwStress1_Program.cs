...
namespace Nc1ExNwStress1
{
	class Nc1ExNwStress1_Program
	{
		public static NccpcSflMt1Simple1 gFlog = null; //new NccpcSflMt1Simple1("Nc1ExNwStress1", 0xffff);
		public static void qv(string s1) { Console.WriteLine(s1); if (gFlog != null) { gFlog.write(s1); } }
		public static string
				gHost = Nc1ExNwStress1.Properties.Settings.Default.Host,
				gServ = Nc1ExNwStress1.Properties.Settings.Default.Serv;
		public static int gCtmax = Nc1ExNwStress1.Properties.Settings.Default.CtMax;
		public static int gPkBfMax = Nc1ExNwStress1.Properties.Settings.Default.PkBfMax;
		...
		public class TtSv : NccpcNw1Sv
		{
			...
			public TtSv(NccpcMemmgr2Mgr mm)
				//: base(0xfff, 0xfff)
			{
				mMm = mm;
			}

			public override void onNccpcNwLog(string s1) { Nc1ExNwStress1_Program.qv(s1); }
			...
			public new void release() { if (!mbCreate) { return; }  mbCreate = false; base.release(); }
						...
						case ConsoleKey.L:
							{
								...
								else { gFlog = new NccpcSflMt1Simple1("Nc1ExNwStress1", 0xffff); qv("Dbg Log on"); }
							}
							break;
					}
				}
